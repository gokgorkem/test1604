...
grub_target_cppflags='-Wno-unused-but-set-variable -Wall -W -I$(top_srcdir)/include -I$(top_builddir)/include  -DGRUB_MACHINE_PCBIOS=1 -DGRUB_MACHINE=I386_PC -m32 -nostdinc -isystem /usr/lib/gcc/i686-linux-gnu/5/include'
...
grub_package="grub"
grub_package_string="GRUB 2.02~beta2-36ubuntu3.32"
grub_package_version="2.02~beta2-36ubuntu3.32"
